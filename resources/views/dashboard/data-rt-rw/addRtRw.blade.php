  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <form method="POST" action="{{route('addRtRw')}}" enctype="multipart/form-data">
          @csrf
              ...
              <div class="box-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <select class="form-control" name="role" id="role-state" required>
                      <option value="">&mdash;Pilih Jabatan / Role&mdash;</option>
